  ...
  request.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      for (var i=0; i<graphs.length; i++) {
        ...
        if (div) graphs[i].draw(herv_name, div);
      }
    }  
  }
  request.send()
...
function chromatin_state_graph(herv_name, div) {
  var request = new XMLHttpRequest();
...
function heatmap_graph(herv_name, div) {
  ...
  ortholog_request.open("GET", "graph_data/ortholog/"+herv_name, true)
  ...
  TFBS_request.open("GET", "graph_data/TFBS_phylogeny/"+herv_name, true)
  ...
  motif_request.open("GET", "graph_data/motif_phylogeny/"+herv_name, true);
...
var graphs = new Graphs(right_div,
                        [{id: "tfbs_depth_graph", draw: tfbs_depth_graph},
                         ...
                         {id: "heat maps", draw: heatmap_graph}]);
